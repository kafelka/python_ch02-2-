...
def selectDate():
    ...
    if isDate == 0:
        return 'https://www.bbc.co.uk/weather/2643743'
    else:
        return f'https://www.bbc.co.uk/weather/2643743/day{isDate}' 
...
def parseHour(html):
    ...
    wind = html.find("span", {"class": "wr-value--windspeed wr-value--windspeed--kph"})
